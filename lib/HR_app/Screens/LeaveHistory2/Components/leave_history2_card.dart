...
class LeaveHistory2Card extends StatefulWidget {
  MyLeaveHistory2 model;
  LeaveHistory2Card({this.model});
  @override
  _LeaveHistory2CardState createState() => _LeaveHistory2CardState();
}

class _LeaveHistory2CardState extends State<LeaveHistory2Card> {
  @override
